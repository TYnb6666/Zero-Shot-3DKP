...
from ULIP.data.dataset_3d import  *

from ULIP.models import losses
...
class ULIP2_WITH_OPENCLIP(nn.Module):
    ...
    def encode_pc(self, pc):
        pc_feat, center, patch_features = self.point_encoder(pc)
        pc_embed = pc_feat @ self.pc_projection
...
def ULIP2_PointBERT_Colored(args):
    ...
    from ULIP.models.pointbert.point_encoder import PointTransformer, PointTransformer_Colored
    import os
