...
from ULIP.models.pointbert import misc
...
class Group(nn.Module):
    ...
    def forward(self, xyz):
        ...
        return neighborhood, center, idx_ret
...
class DiscreteVAE(nn.Module):
    ...
    def recon_loss(self, ret, gt):
        ...
        loss_coarse_block = self.loss_func_cdl1(coarse, group_gt)  # type: ignore[operator]
        loss_fine_block = self.loss_func_cdl1(fine, group_gt)  # type: ignore[operator]
