...
def eval_det_cls(pred: dict[str, Any], gt: dict[str, Any], geo_dists: dict[str, np.ndarray[Any, Any]], dist_thresh: float = 0.1, confidence_thresh: float = 0.0) -> float:
    npos = 0
    fp_sum = 0
    fn_sum = 0
...
def eval_iou(pred_all: dict[str, dict[str, Any]], gt_all: dict[str, dict[str, Any]], geo_dists: dict[str, np.ndarray[Any, Any]], dist_thresh: float = 0.05, confidence_thresh: float = 0.0) -> dict[str, float]:
    iou = {}
...
def gen_geo_dists(pc: np.ndarray[Any, Any]) -> np.ndarray[Any, Any]:
