...
class MolmoForCausalLM(GenerationMixin, PreTrainedModel):
    config_class = MolmoConfig
    base_model_prefix = "model"
    _no_split_modules = ["MolmoBlock"]
    # Disable transformers >= 4.45 DynamicCache pre-allocation (keys=None)
    # which breaks legacy tuple-based past_key_values access.
    @classmethod
