"""Quadratic assignment solver for matching keypoint candidates across shapes."""
...
def optimize_keypoint_candidates(kp_relative_dists, cand_relative_dists, kp_features, cand_features,
                                 num_steps=2000, lr=0.001, dist_alpha=4., selection_beta=0, device: str | torch.device = 'cpu'):
    """
